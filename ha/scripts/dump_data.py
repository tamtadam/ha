...
class RPi():
    mqtt = MQTT( client_name = f"{NAME}", broker=os.environ.get("MQTT_BROKER"), port=int(os.environ.get("MQTT_PORT", 1883)), username=os.environ.get("MQTT_USERNAME"), password=os.environ.get("MQTT_PASSWORD"))
