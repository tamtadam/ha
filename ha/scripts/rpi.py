...
class RPi:
    ...
    base_config = {
        ...
        + f"{Fields.TEMPERATURE.value}.{Fields.CPU.value}.{Fields.CORE_1.value}"
        + " }}",
        "device": {
    ...
    core1["unique_id"] = get_unique_id(["core1", Fields.TEMPERATURE.value])
    core1["object_id"] = get_unique_id(["core1", Fields.TEMPERATURE.value])
    ...
    core2["unique_id"] = get_unique_id(["core2", Fields.TEMPERATURE.value])
    core2["object_id"] = get_unique_id(["core2", Fields.TEMPERATURE.value])
    core2["value_template"] = (
        "{{ value_json."
        + f"{Fields.TEMPERATURE.value}.{Fields.CPU.value}.{Fields.CORE_2.value}"
        + " }}"
    )

    core3 = core1.copy()
    core3["name"] = f"{Utils.get_host_name()} Core3 Temp"
    core3["unique_id"] = get_unique_id(["core3", Fields.TEMPERATURE.value])
    core3["object_id"] = get_unique_id(["core3", Fields.TEMPERATURE.value])
    core3["value_template"] = (
        "{{ value_json."
        + f"{Fields.TEMPERATURE.value}.{Fields.CPU.value}.{Fields.CORE_3.value}"
        + " }}"
    )

    core4 = core1.copy()
    core4["name"] = f"{Utils.get_host_name()} Core4 Temp"
    core4["unique_id"] = get_unique_id(["core4", Fields.TEMPERATURE.value])
    core4["object_id"] = get_unique_id(["core4", Fields.TEMPERATURE.value])
    core4["value_template"] = (
        "{{ value_json."
        + f"{Fields.TEMPERATURE.value}.{Fields.CPU.value}.{Fields.CORE_4.value}"
        + " }}"
    )
    ...
    disk_total["unique_id"] = get_unique_id([Fields.DISK.value, Fields.TOTAL.value])
    disk_total["object_id"] = get_unique_id([Fields.DISK.value, Fields.TOTAL.value])
    ...
    disk_available["unique_id"] = get_unique_id(
        [Fields.DISK.value, Fields.AVAILABLE.value]
    )
    disk_available["object_id"] = get_unique_id(
        [Fields.DISK.value, Fields.AVAILABLE.value]
    )
    ...
    disk_used["unique_id"] = get_unique_id([Fields.DISK.value, Fields.USED.value])
    disk_used["object_id"] = get_unique_id([Fields.DISK.value, Fields.USED.value])
    ...
    memory_total["unique_id"] = get_unique_id([Fields.MEMORY.value, Fields.TOTAL.value])
    memory_total["object_id"] = get_unique_id([Fields.MEMORY.value, Fields.TOTAL.value])
    ...
    memory_available["unique_id"] = get_unique_id(
        [Fields.MEMORY.value, Fields.AVAILABLE.value]
    )
    memory_available["object_id"] = get_unique_id(
        [Fields.MEMORY.value, Fields.AVAILABLE.value]
    )
    ...
    memory_used["unique_id"] = get_unique_id([Fields.MEMORY.value, Fields.USED.value])
    memory_used["object_id"] = get_unique_id([Fields.MEMORY.value, Fields.USED.value])
    ...
    load_c_1["unique_id"] = get_unique_id([Fields.LOAD.value, Fields.MIN_1.value])
    load_c_1["object_id"] = get_unique_id([Fields.LOAD.value, Fields.MIN_1.value])
    ...
    load_c_5["unique_id"] = get_unique_id([Fields.LOAD.value, Fields.MIN_5.value])
    load_c_5["object_id"] = get_unique_id([Fields.LOAD.value, Fields.MIN_5.value])
    ...
    load_c_15["unique_id"] = get_unique_id([Fields.LOAD.value, Fields.MIN_15.value])
    load_c_15["object_id"] = get_unique_id([Fields.LOAD.value, Fields.MIN_15.value])
    ...
    sd_hc["unique_id"] = get_unique_id(
        [Fields.SD_WRITE_SPEED.value, Fields.TOTAL.value]
    )
    sd_hc["object_id"] = get_unique_id(
        [Fields.SD_WRITE_SPEED.value, Fields.TOTAL.value]
    )
